  ...
  <div>
    <v-app-bar class="px-10 py-2" color="surface-dark">
      ...
      <div class="d-flex align-center" @mouseover="handleMouseEnter" @mouseleave="handleMouseLeave">
        ...
        <v-app-bar-title class="text-h5 font-weight-bold"> FabricaDoor </v-app-bar-title>
      </div>
      ...
      <template v-if="!isMobile">
        <v-btn
          v-if="authStore.authUser.isLogged"
          :loading="isDoorOpening"
          :disabled="doorCooldown"
          icon
          variant="tonal"
          color="primary"
          class="mr-2"
          @click="handleQuickOpenDoor"
        >
